...
const FooterLink = (content) => (
	<ListItem>
		<Link to="#" fontSize="sm" colorScheme="#c4c4c4">
			{content}
		</Link>
	</ListItem>
);
...
export default function Footerbottom() {
	...
	return (
		<Box bg="#000" color="#fff" width="100%">
			<Container maxW="container.lg" mt={24}>
				<Divider orientation="horizontal" color="#fff" py={6} />
				<Grid templateColumns="repeat(3, 1fr)" gap={4} mt={4}>
					<GridItem>
						...
						<UnorderedList listStyleType="none" m={0}>
							{account.map((content) => FooterLink(content))}
						</UnorderedList>
					</GridItem>
					<GridItem>
						<Text as="p" fontSize="md" fontWeight="bold">
						...
						<UnorderedList listStyleType="none" m={0}>
							{discover.map((content) => FooterLink(content))}
						</UnorderedList>
					</GridItem>
					<GridItem>
						<Text as="p" fontSize="md" fontWeight="bold">
						...
						<UnorderedList listStyleType="none" m={0}>
							{meetup.map((content) => FooterLink(content))}
						</UnorderedList>
					</GridItem>
				</Grid>
				<Text>Follow us</Text>
